                                                        ...
                                                        <Table>
                                                            ...
                                                            <TableBody>
                                                                {Object.entries(data).map(([key, value]) => (
                                                                    <TableRow key={key}>
                                                                        <TableCell
                                                                            className="font-medium">{key}</TableCell>
                                                                        <TableCell>
                                                                            {key === 'date' ? (
                                                                                null
                                                                            ) : key === 'iamcheck' ? (
                                                ...
                                                <div className="grid">
                                                    <div className="space-y-4 p-4">
                                                        ...
                                                        <div className="flex space-x-2">
                                                            <Button onClick={() => setIsApproved(true)}>승인</Button>
                                                            <Button onClick={() => setIsApproved(false)}>거절</Button>
                                                        </div>
                                                        {isApproved === false && (
                                                            <>
                                                        ...
                                                        {isApproved === true && (
                                                            <>
                                                                ...
                                                                <Select onValueChange={setSelectedRegion}>
                                                                    ...
                                                                    <SelectContent>
                                                                        <SelectItem value="compute1">1번
                                                                            서버</SelectItem>
                                                                        <SelectItem value="compute2">2번
                                                                            서버</SelectItem>
                                                                        <SelectItem value="compute3">3번
                                                                            서버</SelectItem>
                                                                        <SelectItem value="compute4">4번
                                                                            서버</SelectItem>
                                                                        <SelectItem value="compute5">5번
                                                                            서버</SelectItem>
                                                                    </SelectContent>
                                                                </Select>
